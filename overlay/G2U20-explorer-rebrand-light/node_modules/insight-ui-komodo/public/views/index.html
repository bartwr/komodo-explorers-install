  ...
  <div class="container">
    <div id="home" class="row">
      ...
      <div class="col-xs-12 col-md-4 col-gray">
        <h2 translate=""><span class="ng-scope">Met elkaar van het resultaat genieten</span></h2>
        <p id="intro">Bij Gig2u staan we voor succesvol, plezierig en veilig resultaat genieten.</p>
        
        <div id="powered" class="row">
          <div class="powered-text">
            <small class="text-muted" translate=""><span class="ng-scope">Powered by</span></small>
          </div>
          <a align="center" style="display: block">Clearing Service Provider</a>
        </div>
      </div>
    </div>
  </div>
